...
/** ****/ 	'use strict';
  ...
  \**********************/
        /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            eval('__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ "./src/styles.css");\n/* harmony import */ var _modules_update_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/update.js */ "./src/modules/update.js");\n/* harmony import */ var _modules_refresh__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/refresh */ "./src/modules/refresh.js");\n/* eslint-disable no-unused-vars */\r\n\r\n// import Entry from \'./modules/Entry.js\';\r\n\r\n\r\n\r\n\r\nconst submitBtn = document.querySelector(\'#submit-btn\');\r\nconst refreshBtn = document.querySelector(\'#refresh-btn\');\r\nconst nameInput = document.querySelector(\'#iui-name\');\r\nconst scoreInput = document.querySelector(\'#iui-score\');\r\n\r\nsubmitBtn.addEventListener(\'click\', () => {\r\n  const name = nameInput.value;\r\n  const score = scoreInput.value;\r\n\r\n  (0,_modules_update_js__WEBPACK_IMPORTED_MODULE_1__["default"])(name, score);\r\n});\r\n\r\nrefreshBtn.addEventListener(\'click\', _modules_refresh__WEBPACK_IMPORTED_MODULE_2__["default"]);\n\n//# sourceURL=webpack://leaderboard/./src/index.js?');
            /***/}),
  ...
  \********************************/
        /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst scoresOutput = document.querySelector(\'#oui-scores\');\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (refresh = async () => {\r\n  const response = await fetch(\'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/PcJWZ3xtjbnlueoflkPo/scores/\');\r\n  const data = await response.json();\r\n  const { result } = data;\r\n\r\n\tconsole.log(\'working...\');\r\n  console.log(`data: ${data}`);\r\n  console.log(`result: ${result}`);\r\n\r\n  for (const x in result) {\r\n\t\tconst entryDiv = document.createElement(\'div\');\r\n\t\tconst entryText =  document.createElement(\'p\');\r\n\r\n\t\tentryText.textContent = `${x.user}: ${x.score}`;\r\n\t\tentryText.classList.add(\'entry-text\');\r\n\r\n\t\tentryDiv.classList.add(\'entry-div\');\r\n\t\tentryDiv.append(entryText);\r\n\r\n\t\tscoresOutput.append(entryDiv);\r\n\t};\r\n});\n\n//# sourceURL=webpack://leaderboard/./src/modules/refresh.js?');
            /***/}),
  ...
  \*******************************/
        /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            eval('__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (update = async (name, score) => {\r\n  const data = {\r\n    name,\r\n    score,\r\n  };\r\n\r\n  const post = {\r\n    method: \'POST\',\r\n    headers: { \'Content-Type\': \'application/json\', },\r\n    body: JSON.stringify(data),\r\n  };\r\n\r\n  await fetch(\'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/PcJWZ3xtjbnlueoflkPo/scores/\', post);\r\n});\n\n//# sourceURL=webpack://leaderboard/./src/modules/update.js?');
            /***/}),
